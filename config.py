...
meetingDayMovie = int(os.getenv('MEETING_DAY_MOVIE', calendar.THURSDAY))
meetingDayAltMovie = int(os.getenv('MEETING_DAY_MOVIE', calendar.FRIDAY))
meetingHourMovie = int(os.getenv('MEETING_HOUR_MOVIE', 21))
meetingMinuteMovie = int(os.getenv('MEETING_MINUTE_MOVIE', 0))
reminderHourMovie = int(os.getenv('MEETING_HOUR', 20))
